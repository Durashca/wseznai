            ...
            <div class="row">
                <div class="container-material">
                    ...
                    <ul>
                        ...
                        <li>Вы всегда можете вернуться к уроку. Нажмите на кнопку <b>материал</b>, на верхней панели.
                        </li>
                        <li>Не все задания будут доступны на телефонах, поэтому рекомендую проходить задания на моем
                            сайте на ноутбуке или пк.
                        </li>
                    </ul>
