        ...
        <div class="row">
            <div class="container-material">
                <content>
                    ...
                    <!--
                                        <div class="bd-callout bd-callout-lilac">
                    -->
                    ...
                    <p>Чтобы
                        использовании клавиши о которых пойдет речь в этом уроке, вам надо знать что
                        делает кнопка <b>Num Lk</b>(она в правой части клавиатуры).</p>
                    <!--
                                        </div>
                    -->

                    <div class="bd-callout bd-callout-red">
                        Обратим внимание, что под <b>Num Lk</b>, есть цифры и по углам расположены английские слова.
                        Так вот, <b>Num Lk</b> переключает с цифр на эти слова и обратно.<!-- Вот эти слова нам и нужны, т.
                        к. они выполняют важные функции.--> Если вы увидите что во время выполнения задания вы поставили
                        цифру, то у вас включен <b>Num Lk</b>. Нажмите на него, чтобы выключить.
                    </div>

                    <div class="bd-callout bd-callout-info">Определить включен <b>Num Lk</b> или нет, можно с
                        помощью светодиодов(их 3), они обычно выше клавиатуры.
                    </div>
                    ...
                    <div class="keyboard-shortcut-block">
                        ...
                        <ol>
                            ...
                            <li>Посмотрите, на курсор, если он вначале стоки, то у вас получилось.</li>
                        </ol>
                    </div>
                    ...
                    <div class="keyboard-shortcut-block">
                        ...
                        <ol>
                            ...
                            <input type="text" style="width: 100%" value="Ennnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnd">
                            <li>Найдите кнопку <b>End</b>(она находится ниже с <b>Home</b>).</li>
                            <li>Нажмите на нее 1 раз.</li>
                            <li>Если вы не перешли в конец строки курсором, а поставили единичку, то нажмите на <b>Num
                                Lk</b>(Num Lock) и повторите все еще раз.
                            </li>
                            <li>Посмотрите, на курсор, если он конце стоки, то у вас получилось.</li>
                        </ol>
                    </div>

                    <!--карточка-->
                    <div class="bd-callout bd-callout-info">Используйте <b>Home</b> и <b>End</b> в любых средах таких
                        как: <i>Word</i>, <i>блокнот</i> и тд.
                    </div>


                    <!--карточка-->
                    <div class="bd-callout bd-callout-warning">
                        Если вы работаете в браузере, то наведите сперва на поле с тестом!!! Потому что, <b>Home</b> и
                        <b>End</b> не только могут перемещать курсор вперед и назад теста, но и мотать страницу
                        вверх(<b>Home</b>) и вниз(<b>End</b>) если курсор не стоит не в каком поле для введения текста.
                    </div>
                    ...
                    <div class="keyboard-shortcut-block">
                        ...
                        <ol>
                            ...
                            <li>Если вы не переместились на верхушку сайта, то у вас включен <b>Num Lk(Num Lock)</b>,
                                нажмите на него, чтобы отключить.
                            </li>
                        </ol>
                    </div>
                    <!--End-->
                    <div class="keyboard-shortcut-block">
                        <h4>Научимся делать тоже самое, но с <b>End</b>(конец) на сайте:</h4>
                        <ol>
                            <li>Кликните в любую точку сайта, <b>только не на текстовое поле!</b></li>
